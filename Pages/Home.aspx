    ...
    <!-- Services section -->
        <div class="row">
            ...
            pharmacists and Pharmacy.</p>
                        <a href="EPM.aspx" class="btn btn-primary">Learn More</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="EMR.aspx" class="btn btn-primary">Learn More</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="EHR.aspx" class="btn btn-primary">Learn More</a>
                    </div>
                </div>
            </div>
        </div>
